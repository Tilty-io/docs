...
Vous pouvez [définir  le rôle d'un utilisateur depuis le dashboard](#les-rôles-utilisateurs).
...
Vous pouvez activer et désactiver les deux modes [depuis les paramètres](#les-paramètres) ou depuis la plupart des menus contextuels.

![](images/mode_switch.png)
